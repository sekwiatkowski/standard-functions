...
var _conditionalityFunctions = require("./booleans/conditionality-functions");

Object.keys(_conditionalityFunctions).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _conditionalityFunctions[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _conditionalityFunctions[key];
    }
  });
});
...
var _resultFunctions = require("./result-functions");

Object.keys(_resultFunctions).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _resultFunctions[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _resultFunctions[key];
    }
  });
});